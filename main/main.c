...
#include "esp_log.h"
#include "lvgl.h"
#include "ui/ui.h" //import UI element for Squareline studio
#include "WiFi/WiFi.h"
...
void app_main(void)
{
  ...
  /* char *accessPtName = WiFiGetAccessPtName();
  char *password = WiFiGetPassword();
  if ( accessPtName != NULL && password != NULL )
  {
       WiFiConnect(accessPtName, password);
  }*/
